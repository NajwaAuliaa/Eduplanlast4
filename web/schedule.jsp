        ...
        <tbody>
            <tr>
                ...
                <% 
                    ...
                    // Retrieve activities from the request attribute
                    List<Activity> activities = (List<Activity>) request.getAttribute("activities");

                    if (activities != null) {
                        for (Activity activity : activities) {
                            String dayOfWeek = activity.getDayOfWeek();
                            String rawStartTime = activity.getStartTime(); // Start time as string
                            ...
                            try {
                                ...
                                formattedStartTime = rawStartTime; // Fallback to raw if parsing fails
                            }
                            ...
                            // Match activity to the correct day and append it
