...
<html lang="en">
    ...
    <body>
        ...
        <script>
            // Function to fetch timer updates from the server
            function fetchTimerUpdate() {
                ...
                xhr.onreadystatechange = function () {
                    if (xhr.readyState === 4 && xhr.status === 200) {
                        ...
                        // Check if timeLeft exists and is a valid number
                        if (response.timeLeft && !isNaN(response.timeLeft)) {
                            ...
                            // Default display if no valid timer data is available
            ...
            // Start fetching updates every second
