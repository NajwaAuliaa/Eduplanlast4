        ...
        <div class="container">
            ...
            <form action="checklist" method="post" class="mode-card">
                ...
                <div class="mode-description">
                    ...
                    <ul>
                        <li><strong>Tuliskan aktivitas yang akan dilakukan</strong>: Buat daftar pekerjaan yang perlu diselesaikan.</li>
                        <li><strong>Atur waktu untuk aktivitas</strong>: Tandai setiap tugas yang sudah selesai, agar lebih terstruktur.</li>
                    </ul>
